...
\begin{tabular}{ l||m{4cm}|m{4cm}|m{4cm}|  }
  ...
  \hline
  Frameworks & Electron, React Native, Laravel & React, Redux/Flux, Vue.js, WatermelonDB & jQuery \\
  \hline
...
\cventry
  ...
  Technologies: React, WatermelonDB, Vue.js, Vuex.}
\cventry
  {Mar 2018 - Aug 2018}
  {Web developer}
...
\cventry
  ...
  Took part in the development of a new backend of Mail on Node.js\newline{}
...
\section{Projects}
  ...
  \cvline
    ...
    Getting skills working with Custom Elements and native JS.}
  \cvline
